...
# Bot information
API_ID = environ.get('API_ID', '27317700')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', 'de1077f45e29e6abebcd2b9dd196be1d') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '5881638979') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002186277686').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002238367718').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002189558653') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002189558653') #support group id ex:  -1002936246860
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/NcHSupport')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/NCHrequestChannel')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/notcrazyhuman')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/sayyed_kashifali")
...
STICKERS_IDS = (
    "CAACAgEAAxkBAAIX7WbS3Th8UaoX588h_NKsHWLNORMLAAJ_AwACIPOJRhs9TwfAhiWKHgQ"
).split()
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002189558653") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "associated-remy-nchautofilter-91ed9bfd.koyeb.app/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
