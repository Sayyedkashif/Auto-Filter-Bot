...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002189558653').split()]
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002158262712') #support group id ex:  -1002936246860
...
URL = environ.get("URL", "https://associated-remy-nchautofilter-91ed9bfd.koyeb.app/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
